...
export const AppVariables = {
  ...
  Tab: 2,
  User: {},
  ValidCheckText_email: '',
  ValidCheckText_name: '',
  ValidCheckText_pass_cur: '',
  ValidCheckText_pass_new: '',
  ValidCheckText_password: '',
  ValidCheckText_password_r: '',
  ValidCheckText_phone: '',
  authHeader: '',
  email: '',
  fullName: '',
  imageUri: '',
  ...
  isValidEmail: false,
  isValidName: false,
  isValidPassword_cur: false,
  isValidPassword_new: false,
  isValidPhoneNumber: false,
  islogin: false,
  langs: ['English', 'Franch', 'Germany'],
  notValidConfirm: "Passwords don't match!",
  notValidEmail: 'Not Valid Email!',
  notValidName: 'Not Valid Name!',
  notValidPass_cur: 'Not Valid Password!',
  notValidPass_new: 'Not Valid Password!',
  ...
  skills: ['Fishing', 'Driving', 'Singing'],
